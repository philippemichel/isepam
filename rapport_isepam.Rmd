...
tt$examinateur.1 <- as.factor(ifelse((tt$sexe == "H" & tt$surface.1.taille < 524)|(tt$sexe == "F" & tt$surface.1.taille < 385),"sarcopénique", "non sarcopénique"))
tt$examinateur.2 <- as.factor(ifelse((tt$sexe == "H" & tt$surface.2.taille < 524)|(tt$sexe == "F" & tt$surface.2.taille < 385),"sarcopénique", "non sarcopénique"))
# imc
...
tt2 <- tt2 %>% 
  mutate(asa = as.factor(asa))
tt2$sarcopenie <- as.factor(ifelse((tt2$sexe == "H" & tt2$surface.taille < 524)|(tt2$sexe == "F" & tt2$surface.taille < 385),"sarcopénique", "non sarcopénique"))
# imc
...
tt %>% 
  ggplot() +
  aes(x = surface.1.taille, y = surface.2.taille) +
  geom_point() +
  geom_abline() +
...
La différence entre les deux groupes n'est pas significative (eaxmianteur 1 :`r bp1`, examinateur 2 : `r bp2`). Il est probable que la petite taille de l'échantillon soit en cause.
...
Calcul fai pour l'examinateur 1.
